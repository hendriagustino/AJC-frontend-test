...
class BrowsePage extends Component{
    ...
    render(){
        ...
        const mapPlan = this.state.content.map(planElement=>{
            return (
                    ...
                    > 
                      ...
                      {
                        planElement.insuranceProviderId === 'HDFC_ERGO' ? 
                          <img src={HDFC_ERGO} alt={HDFC_ERGO} style={{width:'70px',height:'30px'}}/>
                        : 
                          (
                            planElement.insuranceProviderId === 'RELIANCE_GENERAL' ? 
                      ...
                      <p><b>{planElement.plan.planName}</b></p>
                      <p>
                        Provider: {planElement.plan.insuranceProviderName}<br/>
                        Sum Insured: {planElement.sumInsured}<br/>
